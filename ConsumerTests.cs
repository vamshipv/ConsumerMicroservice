...
namespace ConsumerMicroserviceTests
{
    public class Tests
    {
        ...
        public void CreateConsumerTest(int ConsumerId ,string Name, DateTime Dob, string Email, string PanNumber, int AgentId, string AgentName, bool expectedResult)
        {
        ...
        public void UpdateConsumerTest(int ConsumerId, string Name, DateTime Dob, string Email, string PanNumber, int AgentId, string AgentName, bool expectedResult)
        {
            Consumer consumer = new Consumer()
            {
                ConsumerId = ConsumerId,
